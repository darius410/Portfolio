...
function Footer() {
    ...
    return (
        ...
        <div className="flex flex-col lg:flex-col justify-center items-center footer-bg pt-12 text-center text-black text-3xl  w-full h-[200px]  lg:px-20 lg:justify-between lg:h-[200px] lg:items-center" >
     
                  <img src="./src/img/Untitled-2.png" className="w-1/3  relative top-[-3px] self-center md:w-1/2 lg:w-2/6"/>
