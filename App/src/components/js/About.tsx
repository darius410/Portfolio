    ...
    <div className="matrixBack justify-center h-full bg-black text-white" >
      ...
      <div className="flex flex-col">
          ...
          <div className="flex m-auto justify-center lg:w-4/6">
            ...
            <ol className="font-primary flex flex-col lg:flex-wrap gap-1  pb-1 lg:pb-10 justify-center m-auto w-full lg:h-[300px] lg:gap-2 ">
              
              <li className="blogs  text-white lg:w-1/2 lg:h-20 text-3xl pl-3">Mastering Javascript Before 30<p className="text-xl font-secondary ">Esse aute nostrud nulla ea.Duis pariatur et eiusmod sint voluptate consectetur magna fugiat nostrud mollit culpa dolore nostrud cupidatat.</p></li>
